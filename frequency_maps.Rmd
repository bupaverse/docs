...
*	__relative-case__ frequency
	*	__Nodes__: The proportion of cases in which an activity was executed
...
Each of these flavors can be configured by passing `type = frequency()` to `process_map()`, additionally specifying the type of `frequency()` (ex. "absolute", "absolute-case", etc.)
