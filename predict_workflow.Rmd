---
title: "Introduction to processpredictR: a basic workflow"
---
...
* __remaining trace__: predict the sequence of all next activity instances
...
knitr::include_graphics("docs/images/framework.PNG")
```
...
```{r, out.width="100%", fig.width = 7} 
knitr::include_graphics("docs/images/confusion_matrix.PNG")
```
