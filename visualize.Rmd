				   ...
				   layout_column_wrap(
				   	...
				   	card( 
				   		...
				   		layout_column_wrap(width = 0.5,
				   						   card_image("images/icons/visualize.PNG", href = "control_flow_analysis.html", container = card_body),
					...
					card(
						...
						card_image("images/icons/visualize.PNG", href = "process_matrix.html", container = card_body)
					)), 
					layout_column_wrap(
						width = "250px",
						card( 
							...
							card_image("images/icons/visualize.PNG", href = "dotted_chart.html", container = card_body)
						),
						card( 
							card_header("Trace explorer", class = "card text-white bg-success mb-3"),
							card_image("images/icons/visualize.PNG", href = "trace_exporer.html", container = card_body)
						),
						card( 
							card_header("Performance spectrum", class = "card text-white bg-success mb-3"),
							card_image("images/icons/visualize.PNG", href = "performance_spectrum.html", container = card_body))))
